...
zeroTime = currentTime - timedelta(hours = 23, minutes = 25)


with open ('sample.csv', 'w', newline = '\n', encoding="utf-8") as file:
    writer = csv.writer(file, delimiter=",")
    writer.writerow(["mac", "machine","user", "updatedAt",
    "lastQcAt","orderId","productName","isVeg", "MinWeight",
    "Weight","MaxWeight","weightCheckRequired", "weightSimulated",
    "MinTemp","Temp","MaxTemp","tempCheckRequired", "tempSimulated",
    "foodImage","foodImageSimulated","faceImage", "faceImageSimulated",
    "live_temp", "TempSensor", "weightScale", "foodCamera", "faceCamera",
    "clientServer", "State", "QC_Result"])
